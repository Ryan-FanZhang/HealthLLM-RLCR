"""
PMData Healthcare Dataset Creation Script

This script processes PMData CSV files (fatigue, readiness, sleep_quality, stress)
...
Usage:
    ...
    python data/creation_scripts/pmdata_healthcare.py --sys_prompt tabc

CSV file paths (modify as needed):
    /home/fzha836/HealthLLM-RLCR/data/PMData/PMData_fatigue.csv
    /home/fzha836/HealthLLM-RLCR/data/PMData/PMData_readiness.csv
    /home/fzha836/HealthLLM-RLCR/data/PMData/PMData_sleep_quality.csv
    /home/fzha836/HealthLLM-RLCR/data/PMData/PMData_stress.csv
"""
...
CSV_FILES = {
    "fatigue": "/home/fzha836/HealthLLM-RLCR/data/PMData/PMData_fatigue.csv",
    "readiness": "/home/fzha836/HealthLLM-RLCR/data/PMData/PMData_readiness.csv",
    "sleep_quality": "/home/fzha836/HealthLLM-RLCR/data/PMData/PMData_sleep_quality.csv",
    "stress": "/home/fzha836/HealthLLM-RLCR/data/PMData/PMData_stress.csv",
}
...
def create_dataset_for_prompt(raw_dataset, sys_prompt_name, output_dir):
    ...
    # Save
    save_path = os.path.join(output_dir, f"pmdata_{sys_prompt_name}")
...
def main():
    parser = argparse.ArgumentParser(description="Process PMData healthcare CSV files")
    ...
    parser.add_argument("--hub_name", type=str, default=None,
                        help="HuggingFace Hub dataset name prefix (e.g., 'username/pmdata')")
    
    args = parser.parse_args()
    
    print(f"\n{'='*70}")
    print("PMData Healthcare Dataset Processing")
    print(f"{'='*70}")
    ...
    if args.sys_prompt == "all":
        ...
        for prompt_name in ALL_SYS_PROMPTS:
            print(f"  - {args.output_dir}/pmdata_{prompt_name}/")
        
        print("\nTo load a dataset:")
        print("  from datasets import load_from_disk")
        print(f"  dataset = load_from_disk('{args.output_dir}/pmdata_tabc')")
    else:
        print(f"\nTo load the dataset:")
        print("  from datasets import load_from_disk")
        print(f"  dataset = load_from_disk('{args.output_dir}/pmdata_{args.sys_prompt}')")
